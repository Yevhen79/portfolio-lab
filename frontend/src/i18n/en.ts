export const en = {
  ...
  builder: {
    ...
    swaps_included_note: "{broker} overnight swap costs are already included — the portfolio reflects what you keep after daily financing.",
  ...
  backtest: {
    ...
    running: "Running…",
    summary_as_of: "As-of",
    summary_forward_end: "Forward end",
    summary_months: "Window",
    summary_final: "Final value",
    months_unit: "mo",
    compare_title: "Plan vs Fact",
    compare_subtitle:
      "What the optimiser predicted on the as-of date versus what the held weights actually delivered in the realised window.",
    col_metric: "Metric",
    col_planned: "Plan",
    col_actual: "Fact",
    col_delta: "Δ",
    metric_return_annual: "Expected return (annualised)",
    metric_cagr: "CAGR",
    metric_volatility: "Volatility (annualised)",
    metric_sharpe: "Sharpe ratio",
    ...
    equity_title: "Realised equity curve",
    equity_subtitle: "Actual portfolio value over the {n}-month forward window.",
    equity_line_label: "Portfolio",
    equity_baseline_label: "Initial capital",
    per_asset_title: "Per-asset realised vs predicted",
    per_asset_subtitle:
      "Each holding's actual total return over the forward window vs the optimiser's expected annual return.",
    per_asset_plan: "Plan E[r]",
    per_asset_actual: "Realised",
    per_asset_delta: "Δ",
